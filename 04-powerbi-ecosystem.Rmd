...
![Power BI Desktop start screen showing data connection options](assets/images/screenshots/powerbi-desktop-start-screen.png){width=100%}
...
![Power BIMobile](assets/images/screenshots/PowerBi-Mobile.png){width=100%}
...
![Power BI Gateway](assets/images/screenshots/Power-Bi-Gateway.png){width=100%}
